...
const char* mqtt_server    = "LINK_TO_MQTT_BROKER";
const char* mqtt_username  = "USERNAME";
const char* mqtt_password  = "PASSW0RD";
const int   mqtt_port      = 8883;          // Secure MQTT over TLS
const char* device_id      = "DEVICE_ID"; // Unique client identifier
...
String path = "LINK_TO_FIRMWARE_PATH"; // Path to the firmware binary on GitHub
uint16_t port = 443;
